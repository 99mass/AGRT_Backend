...
public class ApplicationServiceImpl implements ApplicationService {
    ...
    // applicationWithDocumentsDTO) {

    // // Vérifier si le candidat existe
    // User candidate;
    // try {
    // candidate =
    // userRepository.findById(applicationWithDocumentsDTO.getCandidateId())
    // .orElseThrow(() -> new UserServiceException("Candidat non trouvé",
    ...
    // try {
    // announcement =
    // announcementRepository.findById(applicationWithDocumentsDTO.getAnnouncementId())
    // .orElseThrow(() -> new UserServiceException("Annonce non trouvée",
    // HttpStatus.NOT_FOUND));
    // } catch (Exception e) {
    // throw new UserServiceException("Annonce non trouvée", HttpStatus.NOT_FOUND);
    // }
    ...
    // academicYearRepository.findById(applicationWithDocumentsDTO.getAcademicYearId())
    // .orElseThrow(() -> new UserServiceException("Année académique non trouvée",
    // HttpStatus.NOT_FOUND));
    // } catch (Exception e) {
    // throw new UserServiceException("Année académique non trouvée",
    // HttpStatus.NOT_FOUND);
    // }

    // // Vérifier si l'annonce est ouverte
    // if (!announcement.isOpen()) {
    // throw new UserServiceException("Cette annonce n'est plus ouverte aux
    // candidatures", HttpStatus.BAD_REQUEST);
    // }

    // // Vérifier si le candidat peut postuler
    // if (!canCandidateApply(candidate.getId(), announcement.getId())) {
    // throw new UserServiceException("Vous avez déjà postulé à cette annonce",
    ...
    // } catch (Exception e) {
    // throw new UserServiceException("Erreur lors de la sauvegarde de la
    // candidature",
    // HttpStatus.INTERNAL_SERVER_ERROR);
    // }
    ...
    // // Ajouter les documents
    // for (DocumentDTO documentDTO : applicationWithDocumentsDTO.getDocuments()) {
    // addDocumentToApplication(savedApplication.getId(),
    ...
    // HttpStatus.NOT_FOUND));
    // } catch (Exception e) {
    // throw new UserServiceException("Erreur lors du rechargement de la
    // candidature",
    // HttpStatus.INTERNAL_SERVER_ERROR);
    // }
